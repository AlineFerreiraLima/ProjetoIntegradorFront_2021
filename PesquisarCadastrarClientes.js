                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Button title="Pesquisar por id" type="solid" onPress={() => {
                                if (id === "") {
                                    ...
                                    props.navigation.navigate("BuscaClientes", id)
                                }
                            }} />
                        </View>
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <TextInput
                                ...
                                placeholder="Informe o CNPJ do item"
                                value={cnpj.toString()}
                            />
                            <Button title="Pesquisar por CNPJ" type="solid" onPress={() => {
                                if (cnpj === "") {
                                    Alert.alert("Informe CNPJ do Item!")
                                }
                                else {
                                    props.navigation.navigate("BuscaClientesCnpj", cnpj)
                                }
                            }} />
                        </View>
                    </View>
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <Button title="Cadastrar Cliente" type="solid" onPress={() => props.navigation.navigate("CadastroClientes")} />
                    </View>
                </View>
            </View>
        </View >
